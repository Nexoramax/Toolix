...
export function QRCodeGenerator({ language }: { language: 'en' | 'ar' }) {
  const [text, setText] = useState('https://toolix.app');
...
<meta property="og:url" content="${url || 'https://toolix.app'}">
...
<meta property="og:image" content="${image || 'https://toolix.app/banner.png'}">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="${url || 'https://toolix.app'}">
...
<meta property="twitter:image" content="${image || 'https://toolix.app/banner.png'}">`;
    setTags(meta);
